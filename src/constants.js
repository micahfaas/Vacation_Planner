...
export const PLACE_CATEGORIES = {
  ...
  coffee:     { label: 'Coffee',     icon: 'ti-cup' },
  bakery:     { label: 'Bakery',     icon: 'ti-bread' },
  dessert:    { label: 'Dessert',    icon: 'ti-ice-cream' },
  bar:        { label: 'Bar',        icon: 'ti-glass-full' },
  pub:        { label: 'Pub',        icon: 'ti-beer' },
  brewery:    { label: 'Brewery',    icon: 'ti-barrel' },
  wine:       { label: 'Wine bar',   icon: 'ti-glass-champagne' },
  cocktail:   { label: 'Cocktail bar', icon: 'ti-glass-cocktail' },
  tea:        { label: 'Tea house',  icon: 'ti-mug' },
  attraction: { label: 'Attraction', icon: 'ti-camera' },
  viewpoint:  { label: 'Viewpoint',  icon: 'ti-mountain' },
  park:       { label: 'Park',       icon: 'ti-trees' },
  museum:     { label: 'Museum',     icon: 'ti-building-bank' },
  market:     { label: 'Market',     icon: 'ti-building-store' },
